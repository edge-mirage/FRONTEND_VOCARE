...
export default function FoneticaPalabras() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={styles.title}>2. Fonética de palabras</Text>
        <Text style={styles.subtitle}>
          <Text style={styles.bold}>Ahora reconoceremos las fonéticas de las palabras</Text>. Graba un audio por palabra. Puedes
