...
export default function RegistroSintomasConductuales({ navigation, route }: any) {
  ...
  const handleContinuar = async () => {
    ...
    try {
      ...
      for (const [key, frecuencia] of Object.entries(seleccionados)) {
      ...
      console.log('✅ [SÍNTOMAS CONDUCTUALES] Registrados exitosamente');
    } catch (error: any) {
      console.error('❌ [SÍNTOMAS CONDUCTUALES] Error:', error);
